              ...
              <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-6">
                ...
                {isEmpty ? (
                  ...
                  >
                    ...
                    <motion.div variants={itemVariants} className="p-1 rounded-xl bg-[#EFE8DC] flex gap-1">
                      <button
                        type="button"
                    ...
                    {/* Promo Code Form */}
                    <motion.form variants={itemVariants} onSubmit={handleApplyPromo} className="pt-2">
